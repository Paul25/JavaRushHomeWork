...
на экран в виде: «May is 5 month».
*/
...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Map<String,Integer> map = mapOfMonth();

        //ищем пару ключ - значение и печатаем там же
        Month(keyString, map);
    }

    private static void Month(String s, Map<String,Integer> map)
    {
    ...
    private static Map<String, Integer> mapOfMonth()
    {
